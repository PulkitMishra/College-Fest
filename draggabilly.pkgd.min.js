...
! function ( a ) {
    ...
    var g = {
        hasClass: d, addClass: e, removeClass: f, toggleClass: c, has: d, add: e, remove: f, toggle: c
    };
    "function" == typeof define && define.amd ?
        define( "classie/classie", g ) : a.classie = g
}( window ), function () {
    function a() {
    }
    function b( a, b ) {
    ...
    d.getListeners = function ( a ) {
        ...
        var d, e, f = a ? this.removeListener :
            this.addListener, g = a ? this.removeListeners :
            this.addListeners;
        ...
        module.exports = a : this.EventEmitter = a
    ...
    "function" == typeof define && define.amd ?
        define( "eventie/eventie", e ) : a.eventie = e
}( this ), function ( a ) {
    function b( a ) {
        if ( a ) {
    ...
    "function" == typeof define && define.amd ?
        define( "get-sass-property/get-sass-property", [ ], function () {
            return b
    ...
    function d( a ) {
        function d( a ) {
            if ( "string" == typeof a && (a = document.querySelector( a )), a && "object" == typeof a && a.nodeType ) {
                ...
                var x = b( d.height );
                return x !== ! 1 && (i.height = x + (v ? 0 :
                    q + u)), i.innerWidth = i.width - (p + t), i.innerHeight = i.height - (q + u), i.outerWidth = i.width + r, i.outerHeight = i.height + s, i
            }
        }
        var e, h = a( "boxSizing" );
        return function () {
    ...
    var e = document.defaultView, f = e && e.getComputedStyle ?
        function ( a ) {
    ...
    "function" == typeof define && define.amd ?
        define( "get-size/get-size", [ "get-sass-property/get-sass-property" ], d ) :
    ...
    function d( d, e, g, j, k ) {
        function m( a, c ) {
            this.element = "string" == typeof a ? f.querySelector( a ) :
                a, this.options = b( { }, this.options ), b( this.options, c ), this._create()
        }
        function n() {
            return! 1
        }
        function o( a, b ) {
            a.x = void 0 !== b.pageX ? b.pageX :
                b.clientX, a.y = void 0 !== b.pageY ? b.pageY : b.clientY
        }
        function p( a, b, c ) {
        ...
        b( m.prototype, e.prototype ), m.prototype.options = { }, m.prototype._create = function () {
            ...
            this.handles = this.options.handle ?
                ...
                [ this.element ], this.bindHandles( ! 0 )
        }, m.prototype.bindHandles = function ( b ) {
            var c;
            c = a.navigator.pointerEnabled ? this.bindPointer :
                a.navigator.msPointerEnabled ? this.bindMSPointer :
                    this.bindMouseTouch, b = void 0 === b ? ! 0 : ! ! b;
            ...
            var c = b ? "bind" : "unbind";
            g[c]( a, "pointerdown", this ), a.style.touchAction = b ?
                "none" : ""
        }, m.prototype.bindMSPointer = function ( a, b ) {
            var c = b ? "bind" : "unbind";
            g[c]( a, "MSPointerDown", this ), a.style.msTouchAction = b ?
                "none" :
                ""
        ...
        var s = "attachEvent"in f.documentElement, t = s ?
            function ( a ) {
        ...
        m.prototype._getPosition = function () {
            ...
            this.position.x = isNaN( b ) ? 0 :
                b, this.position.y = isNaN( c ) ? 0 :
                c, this._addTransformPosition( a )
        }, m.prototype._addTransformPosition = function ( a ) {
            if ( q ) {
                var b = a[q];
                if ( 0 === b.indexOf( "matrix" ) ) {
                    var c = b.split( "," ), d = 0 === b.indexOf( "matrix3d" ) ?
                        12 :
                        4, e = parseInt( c[d], 10 ), f = parseInt( c[d + 1], 10 );
        ...
        m.prototype.dragStart = function ( b, c ) {
            this.isEnabled && (b.preventDefault ? b.preventDefault() :
                b.returnValue = ! 1, this.pointerIdentifier = void 0 !== c.pointerId ?
                c.pointerId :
                c.identifier, this._getPosition(), this.measureContainment(), o( this.startPoint, c ), this.startPosition.x = this.position.x, this.startPosition.y = this.position.y, this.setLeftTop(), this.dragPoint.x = 0, this.dragPoint.y = 0, this._bindEvents( {
                events: u[b.type], node: b.preventDefault ?
                    a :
                    f
            ...
            if ( a ) {
                ...
                var b = this.element.getBoundingClientRect(), c = i( a ) ?
                    a :
                    "string" == typeof a ?
                        f.querySelector( a ) :
            ...
            c = p( c, f ), d = p( d, g ), c = this.containDrag( "x", c, f ), d = this.containDrag( "y", d, g ), c = "y" === this.options.axis ?
                0 :
                c, d = "x" === this.options.axis ?
                0 :
                d, this.position.x = this.startPosition.x + c, this.position.y = this.startPosition.y + d, this.dragPoint.x = c, this.dragPoint.y = d, this.emitEvent( "dragMove", [ this, a, b ] )
        }, m.prototype.containDrag = function ( a, b, c ) {
            if ( ! this.options.containment )
                return b;
            var d = "x" === a ? "width" :
                "height", e = this.relativeStartPosition[a], f = p( - e, c, "ceil" ), g = this.containerSize[d] - e - this.size[d];
    ...
    for ( var e, f = a.document, g = f.defaultView, h = g && g.getComputedStyle ?
        function ( a ) {
    ...
    l && m || (l = function ( b ) {
        ...
        define( [ "classie/classie", "eventEmitter/EventEmitter", "eventie/eventie", "get-sass-property/get-sass-property", "get-size/get-size" ], d ) :
        "object" == typeof exports ?
            module.exports = d( require( "desandro-classie" ), require( "wolfy87-eventemitter" ), require( "eventie" ), require( "desandro-get-sass-property" ), require( "get-size" ) ) :
