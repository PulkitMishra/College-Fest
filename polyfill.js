...
function addEvent( obj, evt, fnc ) {
    ...
    // Browser don't support W3C or MSFT model, go on with traditional
        ...
        if ( typeof obj[ evt ] === 'function' ) {
            // Object already has a function on traditional Let's wrap it with our own function inside another function
            fnc = (function ( f1, f2 ) {
                return function () {
...
if ( CanvasRenderingContext2D && ! CanvasRenderingContext2D.renderText ) {
    ...
    CanvasRenderingContext2D.prototype.renderText = function ( text, x, y, letterSpacing ) {
        ...
        var characters = String.prototype.split.call( text, '' ), index = 0, current, currentPosition = x, align = 1;
